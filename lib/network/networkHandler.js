...
class NetworkHandler {
     ...
     */
    generateArtifacts() {
        return scriptRunner.exec(__dirname + "/../scripts/artifacts.sh", "-a", "OrdererGenesis", "-b", "SystemChannel", "-c", "testChannel", "-d", "Org1MSP", "-e", "/home/saurabhtiwari/projects/src/pegadroid-sample-network", "-f",  __dirname + "/../artifacts")
    }
